/*
 * src/Math/Space3D/Collisions/PointTriangle.hpp
...
namespace EmEn::Base::Math::Space3D
{
	...
	/** @copydoc EmEn::Base::Math::Space3D::isColliding(const Point< precision_t > &, const Triangle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space3D::isColliding(const Point< precision_t > &, const Triangle< precision_t > &, Vector< 3, precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
