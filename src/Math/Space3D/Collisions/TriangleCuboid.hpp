/*
 * src/Math/Space3D/Collisions/TriangleCuboid.hpp
...
namespace EmEn::Base::Math::Space3D
{
	...
	/** @copydoc EmEn::Base::Math::Space3D::isColliding(const Triangle< precision_t > &, const AACuboid< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
