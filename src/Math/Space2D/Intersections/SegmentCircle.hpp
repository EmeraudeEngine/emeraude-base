/*
 * src/Math/Space2D/Intersections/SegmentCircle.hpp
...
namespace EmEn::Base::Math::Space2D
{
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Segment< precision_t > &, const Circle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Segment< precision_t > &, const Circle< precision_t > &, Point< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
