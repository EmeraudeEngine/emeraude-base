/*
 * src/Math/Space2D/Intersections/LineRectangle.hpp
...
namespace EmEn::Base::Math::Space2D
{
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Line< precision_t > &, const AARectangle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Line< precision_t > &, const AARectangle< precision_t > &, StaticVector< Point< precision_t >, 4 > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	uint32_t
