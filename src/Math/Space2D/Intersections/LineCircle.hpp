/*
 * src/Math/Space2D/Intersections/LineCircle.hpp
...
namespace EmEn::Base::Math::Space2D
{
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Line< precision_t > &, Circle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space2D::isIntersecting(const Line< precision_t > &, Circle< precision_t > &, Point< precision_t > &, Point< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	uint32_t
