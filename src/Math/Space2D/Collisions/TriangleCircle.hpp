/*
 * src/Math/Space2D/Collisions/TriangleCircle.hpp
...
namespace EmEn::Base::Math::Space2D
{
	...
	/** @copydoc EmEn::Base::Math::Space2D::isColliding(const Triangle< precision_t > &, const Circle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space2D::isColliding(const Triangle< precision_t > &, const Circle< precision_t > &, Vector< 2, precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
