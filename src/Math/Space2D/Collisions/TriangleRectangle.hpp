/*
 * src/Math/Space2D/Collisions/TriangleRectangle.hpp
...
namespace EmEn::Base::Math::Space2D
{
	...
	/** @copydoc EmEn::Base::Math::Space2D::isColliding(const Triangle< precision_t > &, const AARectangle< precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
	...
	/** @copydoc EmEn::Base::Math::Space2D::isColliding(const Triangle< precision_t > &, const AARectangle< precision_t > &, Vector< 2, precision_t > &) noexcept */
	template< typename precision_t = float >
	[[nodiscard]]
	bool
