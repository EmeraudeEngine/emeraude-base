# Base — Foundation Modules (`EmEn::Base`)

Context for developing the **emeraude-base** foundation library. This was the engine's
`src/Libs/` (`EmEn::Libs`), extracted into a standalone, independently-usable library.

## Module Overview

**Project foundation** — Platform-agnostic modules: base concepts, mathematics, data
manipulation, image/audio/geometry factories, and external integrations. Consumed by
