/*
 * src/VertexFactory/ShapeLoadResult.hpp
...
{
	/**
	 * @brief Result of loading a geometry file that may contain skeletal animation data.
	...
	struct ShapeLoadResult
	{
		...
		std::optional< Animation::Skeleton< vertex_data_t > > skeleton{};
		std::optional< Animation::Skin< vertex_data_t > > skin{};
	};
}
