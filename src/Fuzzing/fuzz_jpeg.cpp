/*
 * fuzzing/fuzz_jpeg.cpp
 * This file is part of Emeraude-Base
 *
 * libFuzzer target for the PixelFactory JPEG parser (Ave robustus! — A.3).
 * Feeds arbitrary bytes through FileFormatJpeg::readStream (libjpeg + our ByteStream) under ASan/UBSan.
 */
