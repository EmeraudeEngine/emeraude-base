/*
 * fuzzing/fuzz_targa.cpp
 * This file is part of Emeraude-Base
 *
 * libFuzzer target for the PixelFactory Targa (TGA) parser (Ave robustus! — A.3).
 * Feeds arbitrary bytes through FileFormatTarga::readStream (hand-rolled RLE/raw) under ASan/UBSan.
 */
