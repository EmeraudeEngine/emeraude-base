...
| [`todo/README.md`](todo/README.md) | **Open work** — one file per idea to do in [`todo/`](todo/); done = file deleted. Design/governance documents stay in `plans/`. |
...
| [`tracy-profiler.md`](tracy-profiler.md) | **Tracy client integration** — `EMERAUDE_ENABLE_TRACY`, why the client must be shared, on-demand mode, how to add a zone. |
